!(function (t) {
  ...
  function a() {
    ...
    t.anchor.set(0.5, 0.5), (t.x = lt.gameWidth0 / 2), (t.y = lt.gameHeight0 / 2), this.addChild(t)
  }
  function o(t) {
    this.app = t
  }
  ...
  function r(t, e, i, n, a) {
    ;(this.up = t),
      ...
      (this.onUp = new p()),
      (this.onOut = new p()),
      n && ((n = n.bind(a || this)), this.onClick.add(n)),
      (this.name = 'Button'),
      (this.disposed = !1),
      (this.isDown = !1),
      (this.isOver = !1),
  ...
  function h(t, i, n) {
    ...
    e.call(this, a, i, n), (this.num = t), (this.name = 'ButtonLevel' + t)
    ...
    this.setLabel(t + '', o), this.scale.set(0.5, 0.5)
  }
  ...
  function _() {
    ;(this.shown = !1), PIXI.Container.call(this)
    ...
    i.scale.set(0.5, 0.5), i.anchor.set(0.5, 0.45), this.addChild(i), this.pivot.set(this.width / 2, this.height / 2)
  }
  function v(t, i) {
    ...
    lt.levelMng.currLevel == lt.levelMng.totalLevels &&
      ((o = "CONGRATULATIONS!\nYOU'VE PASSED THE GAME!"), (a.fontSize = 36)),
  ...
  function b(t) {
    ;(this.shown = !1), PIXI.Container.call(this), (this._buttonsHandler = t)
  ...
  function w(t, e) {
    ...
    var a = g.createCircleShape(7.5),
      o = g.createFixtureDef(a, 0.5, 0.15, 1, { item: this, isBall: !0 }),
      s = g.createBodyDef(t, e, et.b2_dynamicBody, !1, !0, 0, !0)
    ;(this._body = g.createBody(s, [o])), this._enableUpdate(), (this.angleUpdate = !0), (this.positionUpdate = !0)
  }
  function P(t, e) {
    i.call(this, 'Basket', U.zOrder.basket), (this.x = t), (this.y = e)
    var n = lt.assets.getSprite('basket', 'atlasGame')
    n.scale.set(0.55, 0.55), n.anchor.set(0.5, 0.36), this.addChild(n)
    var a = g.createPolygonShape(22.5, 4, 0, 30),
      o = g.createFixtureDef(a, 0.5, 0.1, 1, this),
      s = g.createPolygonShape(4, 42, 14.85, 10.85, q.toRadians(15)),
      r = g.createFixtureDef(s, 0.5, 0.1, 1, this),
      h = g.createPolygonShape(4, 42, -14.85, 10.85, q.toRadians(-15)),
      l = g.createFixtureDef(h, 0.5, 0.1, 1, this),
      c = g.createPolygonShape(7.5, 6.6, 22.8, -7.75, q.toRadians(-15)),
      d = g.createFixtureDef(c, 0.5, 0.1, 1, this),
      p = g.createPolygonShape(7.5, 6.6, -22.8, -7.75, q.toRadians(15)),
      u = g.createFixtureDef(p, 0.5, 0.1, 1, this),
      m = g.createPolygonShape(27, 4),
      y = g.createFixtureDef(m, 0.5, 0.1, 1, { item: this, basketSensor: !0 }, !0),
  ...
  function S(t, e, n, a, o) {
    ...
    s.scale.set(0.55, 0.55), s.anchor.set(0.5, 0.46), this.addChild(s)
    var r = g.createPolygonShape(22.5, 4, 0, 30),
      h = g.createFixtureDef(r, 0.5, 0.1, 1, this),
      l = g.createPolygonShape(4, 42, 14.85, 10.85, q.toRadians(15)),
      c = g.createFixtureDef(l, 0.5, 0.1, 1, this),
      d = g.createPolygonShape(4, 42, -14.85, 10.85, q.toRadians(-15)),
      p = g.createFixtureDef(d, 0.5, 0.1, 1, this),
      u = g.createPolygonShape(7.5, 6.6, 22.8, -7.75, q.toRadians(-15)),
      m = g.createFixtureDef(u, 0.5, 0.1, 1, this),
      y = g.createPolygonShape(7.5, 6.6, -22.8, -7.75, q.toRadians(15)),
      f = g.createFixtureDef(y, 0.5, 0.1, 1, this),
      x = g.createPolygonShape(27, 4),
      _ = g.createFixtureDef(x, 0.5, 0.1, 1, { item: this, basketSensor: !0 }, !0),
  ...
  function I(t, e) {
    ...
    n.anchor.set(0.5, 1), n.scale.set(0.5, 0.5), this.addChild(n)
    ...
    ;(this._cannon = new PIXI.extras.AnimatedSprite(o)),
      ...
      lt.pixi.ticker.add(this._update, this),
      (this._isAllowMove = !0),
      lt.playState.aimControl &&
        (lt.playState.bg.on('pointerdown', this._pointerDown, this),
        lt.playState.bg.on('pointerup', this._pointerUp, this),
        (this._isAllowMove = !1)),
      (this.sndShot = lt.assets.getSound('sndShot'))
  }
  function D(t, e) {
    i.call(this, 'Domino', U.zOrder.defaultZ), (this.x = t), (this.y = e)
    ...
    var a = g.createPolygonShape(10, 50),
      o = g.createFixtureDef(a, 0.5, 0, 0.5, { item: this }),
  ...
  function C(t, e, n, a, o, s) {
    ...
    h.scale.set(0.5, 0.5),
      'left' == n ? h.anchor.set(0.2, 0.5) : 'right' == n && h.anchor.set(0.8, 0.5),
      this.addChild(h)
    var l
    'left' == n ? (l = g.createPolygonShape(30, 8, 11)) : 'right' == n && (l = g.createPolygonShape(30, 8, -11))
    var c = g.createFixtureDef(l, 1, 0.1, 0.1),
  ...
  function T(t, e, n, a) {
    ...
    o.scale.set(0.5, 0.5), o.anchor.set(0.1, 0.5), this.addChild(o)
    var s = g.createPolygonShape(12, 74, 62, 0),
      r = g.createFixtureDef(s, 0.3, 0.1, a, { item: this }),
      h = g.createPolygonShape(59, 12, 26, 0),
      l = g.createFixtureDef(h, 0.3, 0.1, a, { item: this }),
  ...
  function O(t, e) {
    i.call(this, 'Peg', U.zOrder.defaultZ), (this.x = t), (this.y = e)
    var n = lt.assets.getSprite('peg', 'atlasGame')
    n.scale.set(0.5, 0.5), n.anchor.set(0.5, 0.5), this.addChild(n)
    var a = g.createCircleShape(15),
      o = g.createFixtureDef(a, 0.2, 0.1, 1, { item: this, isPeg: !0 }),
  ...
  function B(t, e, n, a) {
    a = q.toRadians(a || 0)
    var o = 15
    i.call(this, 'Platform', U.zOrder.platform), (this.x = t), (this.y = e), (this.rotation = a)
    var s = lt.assets.getSprite('platform', 'atlasGame')
    s.scale.set(0.5, 0.5), s.anchor.set(0.5, 0.5), (s.x = lt.rnd.realInRange(0, s.width / 2 - n / 2)), this.addChild(s)
    var r = 2,
      h = new PIXI.Graphics()
    h.lineStyle(r, 3352345, 1), h.drawRect(-n / 2, -o / 2, n, o), this.addChild(h)
    var l = g.createPolygonShape(n, o),
      c = g.createFixtureDef(l, 1, 0.1, 1, this),
      d = g.createBodyDef(t, e, et.b2_staticBody, !1, !0, a, !1)
    this._body = g.createBody(d, [c])
    var p = new PIXI.Graphics()
    p.beginFill(9160191, 0.4), p.drawRect(-n / 2, -o / 2, n, o), p.endFill(), this.addChild(p), (this.mask = p)
  }
  function E(t, e, n, a) {
    ...
    var r = g.createPolygonShape(30, 4, 0, -12),
      h = g.createFixtureDef(r, 1, 0, 0.1, { item: this, isSensor: !0 }, !0),
      l = g.createPolygonShape(40, 8, 0, -4),
      c = g.createFixtureDef(l, 1, 0, 0.1, this),
      d = g.createBodyDef(t, e, et.b2_staticBody, !1, !0, a)
    ;(this._body = g.createBody(d, [h, c])),
      lt.physics.contactListener.addBeginContactListener(this._onBeginContact, this)
  }
  function k(t, e) {
    i.call(this, 'Stopper', U.zOrder.defaultZ), (this.x = t), (this.y = e)
    var n = lt.assets.getSprite('stopper', 'atlasGame')
    n.scale.set(0.5, 0.5), n.anchor.set(0.5, 0.5), this.addChild(n)
    var a = g.createCircleShape(5),
      o = g.createFixtureDef(a, 0.2, 0.1, 1, this),
      s = g.createBodyDef(t, e, et.b2_staticBody)
    this._body = g.createBody(s, [o])
  }
  function M(t, e, n) {
    i.call(this, 'Swings', U.zOrder.peg), (n = q.toRadians(n)), (this.x = t), (this.y = e), (this.rotation = n)
    var a = lt.assets.getSprite('swings', 'atlasGame')
    a.scale.set(0.5, 0.5), a.anchor.set(0.5, 0.83), this.addChild(a)
    var o = g.createPolygonShape(60, 11, 0, 0.5),
      s = g.createFixtureDef(o, 1, 0, 0.4, this),
      r = g.createPolygonShape(11, 30, 0, -20),
      h = g.createFixtureDef(r, 1, 0, 0.4, this),
  ...
  function L(t, e, n, a, o) {
    ...
    var h = a + o,
      ...
      c = g.createFixtureDef(l, 1, 0.1, 1),
      d = g.createPolygonShape(50, 6, 0, 13.5),
      p = g.createFixtureDef(d, 1, 0.1, 1),
      u = g.createPolygonShape(50 + h, 10, -a / 2 + o / 2),
      m = g.createFixtureDef(u, 1, 0.1, 1, { item: this, tubeSensor: !0 }, !0),
      y = g.createBodyDef(t, e, et.b2_staticBody, !1, !0, n)
    ;(this._body = g.createBody(y, [p, m, c])), this._enableUpdate()
  }
  function R(t) {
    if ((i.call(this, 'Tutorial', U.zOrder.defaultZ), 1 == t)) {
      var e = lt.assets.getSprite('tutorial1_1', 'atlasUI')
      e.scale.set(0.5, 0.5), e.anchor.set(0.5, 0.5), (e.x = 350), (e.y = 100), this.addChild(e)
      ...
      a.scale.set(0.5, 0.5), a.anchor.set(0.5, 0.5), (a.x = 350), (a.y = 100), this.addChild(a)
    }
  }
  function G(t, e, n) {
    i.call(this, 'WightBall', U.zOrder.peg), (n = n || 2), (this.x = t), (this.y = e)
    ...
    var o = g.createCircleShape(40),
      s = g.createFixtureDef(o, 0.2, 0.1, n, this),
      r = g.createBodyDef(t, e, et.b2_dynamicBody)
    ;(this._body = g.createBody(r, [s])), this._enableUpdate(), (this.angleUpdate = !0), (this.positionUpdate = !0)
  }
  function F() {
    if (lt.menuState) throw new Error('MenuState singelton!')
    ;(lt.menuState = this), PIXI.Container.call(this), lt.pixi.stage.addChildAt(this, 0)
    var t = lt.assets.getSprite('bg')
    t.scale.set(0.5, 0.5), this.addChild(t)
    var i = new PIXI.Graphics()
    i.beginFill(0), (i.alpha = 0.4), i.drawRect(0, 0, lt.gameWidth0, lt.gameHeight0), i.endFill(), this.addChild(i)
    var n = lt.assets.getSprite('gameName', null, !0)
    n.scale.set(0.5, 0.5), (n.x = n.width / 2 + 10), (n.y = n.height / 2 + 10), this.addChild(n)
  ...
  function U() {
    if (lt.playState) throw new Error('MenuState singelton!')
    ;(lt.playState = this),
      PIXI.Container.call(this),
    ...
    ;(t.alpha = 0.6),
      ...
      (this.sndButton = lt.assets.getSound('sndButton')),
      this.aimControl &&
        ((this.aim = lt.assets.getSprite('aim')),
  ...
  function N() {
    PIXI.Container.call(this), lt.pixi.stage.addChild(this)
    var t = new PIXI.Graphics()
    t.beginFill(0), t.drawRect(0, 0, lt.gameWidth0, lt.gameHeight0), t.endFill(), this.addChild(t)
  }
  function H() {
    J(),
      lt.inited
        ? ((lt.pixi.renderer.autoResize = !0),
          lt.pixi.renderer.resize(lt.canvasWidth, lt.canvasHeight),
          lt.pixi.stage.scale.set(lt.scale, lt.scale),
          lt.physics.enabledDD && lt.physics.updateCanvasSize())
        : V(),
      lt.resizeHandler && lt.resizeHandler.call(),
      lt.imgRotate &&
        (lt.imgRotate.position.set(lt.canvasWidth / 2, lt.canvasHeight / 2),
        (lt.imgRotate.scale.x = lt.imgRotate.scale.y = lt.scale))
  }
  function V() {
    if (
      ((lt.device = new Device()),
    ...
    i.parentNode.removeChild(i),
      (lt.pixi = new PIXI.Application(lt.canvasWidth, lt.canvasHeight, { antialias: !0 })),
    ...
    if (
      ...
      PIXI.loader
        .add('sndButton', 'audio/buttons' + r)
        .add('sndGate', 'audio/gate' + r)
        .add('sndPeg', 'audio/peg' + r)
        .add('sndRailStart', 'audio/railStart' + r)
        .add('sndRailStop', 'audio/railStop' + r)
        .add('sndShot', 'audio/shot' + r)
        .add('sndTeleport', 'audio/teleport' + r)
        .add('sndTheme', 'audio/theme' + r)
        .add('sndTube', 'audio/tube' + r)
        .add('sndWin', 'audio/win' + r)
    }
    PIXI.loader.on('progress', W).load(z), (lt.inited = !0)
  }
  function W(t, e) {
    if ((console.log('loading: ' + e.url), lt.preloader)) {
      var i = Math.round(t.progress)
      lt.preloader.setLoading(i)
    }
  }
  function z() {
    lt.preloader ? (lt.preloader.setLoading(100), lt.preloader.loadedCallback(Y)) : j()
  }
  function Y() {
    ;(lt.splash = new a()), lt.splash.runAfter(j), lt.pixi.stage.addChild(lt.splash)
  }
  function j() {
    if (
      (lt.preloader && (lt.preloader.destroy(), (lt.preloader = null)),
      lt.splash && (lt.splash.destroy(), (lt.splash = null)),
      $.atHome([]))
    ) {
      lt._checkAudio()
      var t = 1
      1 == t ? new F() : 2 == t && ((lt.levelMng.currLevel = 1), new U()), lt.shutter.hide()
    }
  }
  function J() {
    var e = t.innerWidth,
  ...
  ;(e.prototype = Object.create(PIXI.Sprite.prototype)),
    ...
    (e.prototype.setIcon = function (t, e, i, n, a) {
      if (!this.disposed) {
        ;(i = i || 0), (n = n || 0), (a = a || 1)
        var o
        if ('string' == typeof t) o = this.app.assets.getTexture(t, e)
        else if (t instanceof PIXI.Texture) o = t
    ...
    (i.prototype._update = function () {
      this.angleUpdate && (this.rotation = this._body.GetAngle()),
        this.positionUpdate &&
          ((this.x = this._body.GetPosition().x * lt.physScale), (this.y = this._body.GetPosition().y * lt.physScale))
    }),
    ...
    (n.prototype._update = function () {
      this._curr < this._loaded && (this._curr = Math.round(this._curr + 2 * lt.pixi.ticker.deltaTime)),
        ...
        100 == this._curr &&
          (lt.pixi.ticker.remove(this._update, this), this._loadedCB && setTimeout(this._loadedCB, 500))
    }),
    ...
    (EventTarget = function () {
      ...
      ;(this.addEventListener = this.on =
        ...
        (this.dispatchEvent = this.emit =
          function (e) {
            if (t[e.type] && t[e.type].length) for (var i = 0, n = t[e.type].length; i < n; i++) t[e.type][i](e)
          }),
    ...
    (h.prototype.setLocked = function (t) {
      this._lock ||
        ((this._lock = lt.assets.getSprite('icoLock', 'atlasUI')),
    ...
    (Device.prototype = {
      ...
      _checkCSS3D: function () {
        ...
        for (var a in n)
          void 0 !== i.style[a] &&
            ((i.style[a] = 'translate3d(1px,1px,1px)'), (e = t.getComputedStyle(i).getPropertyValue(n[a])))
  ...
  ;(m.prototype.collectInteractiveSprite = function (t, e) {
    for (var i = t.children, n = i.length, a = 0; a < n; a++) {
      var o = i[a]
      ;(o.visible === !1 && this.interactInvisible === !1) ||
        (o.interactive
          ? (console.log(Z, o.name),
            (o.__iParent = e),
            this.interactiveItems.push(o),
            o.children.length > 0 && ((Z += '\t'), this.collectInteractiveSprite(o, o)))
          : ((o.__iParent = null), o.children.length > 0 && this.collectInteractiveSprite(o, e)))
    }
    Z = ''
  }),
        ...
        if (((e = (30 * e) / 1e3), !(e < 1))) {
          ...
          for (i = n - 1; i >= 0; i--) {
            ...
            if (a.mouseover || a.mouseout || a.buttonMode) {
              if (a.__iParent && a.__iParent.__target) continue
              ;(a.__hit = null != a.__target || this.hitTest(a, this.mouse)),
                a.__hit
                  ? (a.buttonMode && (this.interactionDOMElement.style.cursor = a.defaultCursor),
                    a.__iParent && (a.__iParent.__target = a),
                    a.__target ? (this.mouse.target = a.__target) : (this.mouse.target = a),
                    a.__isOver || (a.mouseover && a.mouseover(this.mouse), (a.__isOver = !0)))
                  : a.__isOver && (a.mouseout && a.mouseout(this.mouse), (a.__isOver = !1))
            }
          }
          for (i = n - 1; i >= 0; i--) (a = this.interactiveItems[i]), (a.__target = null)
        }
      }
    }),
    ...
    (m.prototype.onMouseDown = function (e) {
      ...
      for (console.log(o, i), s = i - 1; s >= 0; s--) (r = this.interactiveItems[s]), (r.__target = null)
    }),
    ...
    (m.prototype.onMouseUp = function (e) {
      ...
      for (var i = this.interactiveItems.length, n = !1, a = 0; a < i; a++) {
        ...
        ;(o.__hit = this.hitTest(o, this.mouse)),
          o.__hit && !n
            ? (o.mouseup && o.mouseup(this.mouse),
              o.__isDown && o.click && o.click(this.mouse),
              o.interactiveChildren || (n = !0))
            : o.__isDown && o.mouseupoutside && o.mouseupoutside(this.mouse),
          (o.__isDown = !1)
      }
    }),
    (m.prototype.hitTest = function (t, e) {
      ...
      if (n) {
        var m,
          y = t.texture.frame.width,
          g = t.texture.frame.height,
          f = -y * t.anchor.x
        if (p > f && p < f + y && ((m = -g * t.anchor.y), u > m && u < m + g)) return (e.target = t), !0
      }
      for (var x = t.children.length, _ = 0; _ < x; _++) {
        var v = t.children[_],
          b = this.hitTest(v, e)
        if (b) return (e.target = v), (e.currentTarget = t), !0
      }
      return !1
    }),
    (m.prototype.onTouchMove = function (e) {
      ...
      for (o = 0; o < a.length; o++) {
        ...
        ;(i = this.touchs[s.identifier]),
          ...
          navigator.isCocoonJS && ((i.global.x = s.clientX), (i.global.y = s.clientY))
      }
    ...
    (m.prototype.onTouchStart = function (e) {
      for (var i = this.interactionDOMElement.getBoundingClientRect(), n = e.changedTouches, a = 0; a < n.length; a++) {
        ...
        s || (s = new PIXI.InteractionData()),
          ...
          navigator.isCocoonJS && ((s.global.x = o.clientX), (s.global.y = o.clientY))
        for (var r = this.interactiveItems.length, h = 0; h < r; h++) {
          var l = this.interactiveItems[h]
          if (
            (l.touchstart || l.tap) &&
            ((l.__hit = this.hitTest(l, s)),
            l.__hit &&
              (l.touchstart && l.touchstart(s), (l.__isDown = !0), (l.__touchData = s), !l.interactiveChildren))
          )
            break
        }
      }
        ...
        for (var h = this.interactiveItems.length, l = 0; l < h; l++) {
          ...
          ;(c.__hit = this.hitTest(c, s)),
            d === s &&
              ...
              (c.touchend || c.tap) &&
                (c.__hit && !r
                  ? (c.touchend && c.touchend(s), c.__isDown && c.tap && c.tap(s), c.interactiveChildren || (r = !0))
                  : c.__isDown && c.touchendoutside && c.touchendoutside(s),
                (c.__isDown = !1)),
              (c.__touchData = null))
        }
        this.pool.push(s), (this.touchs[o.identifier] = null)
      }
    }),
    ...
    (m.InteractionData.prototype.getLocalPosition = function (t) {
      ...
      return new PIXI.Point(
        r * l * i.x + -a * l * i.y + (h * a - o * r) * l,
        n * l * i.y + -s * l * i.x + (-h * n + o * s) * l
      )
    }),
  ...
  ;(q.distance1 = function (t, e, i, n) {
    ...
    (q.intersection = function (t, e, i, n, a, o, s, r, h) {
      if (t === a && e === o) return null != h && ((h.x = t), (h.y = e)), !0
      if (t == s && e == r) return null != h && ((h.x = t), (h.y = e)), !0
      if (i == a && n == o) return null != h && ((h.x = i), (h.y = n)), !0
      if (i == s && n == r) return null != h && ((h.x = i), (h.y = n)), !0
      var l = i - t,
        c = n - e,
        d = s - a,
        p = r - o,
        ...
        w = u * a + m * o + y,
        P = u * s + m * r + y
      if (v * b >= 0 || w * P >= 0) return !1
      var S = v / (v - b)
      ;(l *= S), (c *= S)
      return null != h && ((h.x = f.x), (h.y = f.y)), !0
    }),
    (q.intersection = function (t, e, i, n, a) {
      if (t.x == i.x && t.y == i.y) return null != a && a.set(t), !0
      if (t.x == n.x && t.y == n.y) return null != a && a.set(t), !0
      if (e.x == i.x && e.y == i.y) return null != a && a.set(e), !0
      if (e.x == n.x && e.y == n.y) return null != a && a.set(e), !0
      var o = e.sub(t),
        s = n.sub(i),
        r = -o.y,
        h = o.x,
        ...
        y = r * i.x + h * i.y + l,
        g = r * n.x + h * n.y + l
      if (u * m >= 0 || y * g >= 0) return !1
      var f = u / (u - m)
      ;(o.x *= f), (o.y *= f)
      var x = t.add(o)
      return null != a && (a.x = x.x), null != a && (a.y = x.y), !0
    }),
  ...
  ;($.generateFrameNames = function (t, e, i, n, a) {
    ...
    if (e < i)
      for (o = e; o <= i; o++)
        (r = 'number' == typeof a ? $.pad(o.toString(), a, '0', 1) : o.toString()), (r = t + r + n), s.push(r)
    else
      for (o = e; o >= i; o--)
    ...
    ($.pad = function (t, e, i, n) {
      'undefined' == typeof e && (e = 0), 'undefined' == typeof i && (i = ' '), 'undefined' == typeof n && (n = 3)
      var a = 0
      if (e + 1 >= t.length)
        switch (n) {
          case 1:
  ...
  var Q = Box2D.Common.Math.b2Vec2,
    tt = (Box2D.Collision.b2AABB, Box2D.Dynamics.b2BodyDef),
    et = Box2D.Dynamics.b2Body,
    it = Box2D.Dynamics.b2FixtureDef,
    nt = (Box2D.Dynamics.b2Fixture, Box2D.Dynamics.b2World),
    at = (Box2D.Collision.Shapes.b2MassData, Box2D.Collision.Shapes.b2PolygonShape),
    ot = Box2D.Collision.Shapes.b2CircleShape,
    st = Box2D.Dynamics.b2DebugDraw,
    rt = (Box2D.Dynamics.Joints.b2MouseJointDef, Box2D.Dynamics.Joints.b2RevoluteJointDef)
  ;(g.prototype.constructor = g),
    ...
    (g.createPolygonShape = function (t, e, i, n, a) {
      ...
      return (
        0 == i && 0 == n && 0 == a
          ? o.SetAsBox(t / 2 / lt.physScale, e / 2 / lt.physScale)
          : o.SetAsOrientedBox(
              t / 2 / lt.physScale,
              e / 2 / lt.physScale,
              new Q(i / lt.physScale, n / lt.physScale),
              a
            ),
        o
      )
    ...
    (g.createBody = function (t, e) {
      ...
      if (e) for (var n = e.length, a = 0; a < n; a++) i.CreateFixture(e[a])
      return i
    }),
    ...
    (_.prototype.show = function () {
      ;(this.shown = !0), TweenMax.to(this, 0.5, { x: this.showX, y: this.showY, ease: Expo.easeOut })
    }),
    (_.prototype.hide = function () {
      ;(this.shown = !1), TweenMax.to(this, 0.5, { x: this.hideX, y: this.hideY, ease: Expo.easeOut })
    }),
    ...
    (v.prototype.show = function (t) {
      ...
      this.visible = !0
      var i = this
      TweenMax.to(this, e, { delay: t, alpha: 1 }),
      ...
      var n = Quad.easeOut,
        a = this._btnMenu.xIn,
        o = this._btnMenu.yIn
      TweenMax.to(this._btnMenu, e, { delay: (t += 0.1), x: a, y: o, ease: n }),
        (a = this._btnRestart.xIn),
        (o = this._btnRestart.yIn),
        TweenMax.to(this._btnRestart, e, { delay: (t += 0.05), x: a, y: o, ease: n }),
        (this._btnNext.enable = lt.levelMng.currLevel != lt.levelMng.totalLevels),
        (a = this._btnNext.xIn),
        (o = this._btnNext.yIn),
        TweenMax.to(this._btnNext, e, { delay: (t += 0.05), x: a, y: o, ease: n })
    }),
    ...
    (w.prototype.destroy = function () {
      i.prototype.destroy.call(this), w._balls.remove(this)
    }),
    ...
    (w.prototype._update = function () {
      i.prototype._update.call(this), this.y > lt.gameHeight0 + 50 && this.destroy()
    }),
    ...
    (w.create = function (t, e, i) {
      if (w._balls.total() >= w._maxBalls) {
        ...
        n.destroy(), w._balls.remove(n)
      }
      var a = new w(t, e)
      return i.addChild(a), w._balls.add(a), a
    }),
    (P.prototype = Object.create(i.prototype)),
    (P.prototype.constructor = P),
    (P.prototype.destroy = function () {
      i.prototype.destroy.call(this), lt.physics.contactListener.removeBeginContactListener(this._onBeginContact, this)
    }),
    ...
    (S.prototype._createRails = function () {
      ...
      for (var n = 0; n < i; n++) {
        ...
        a.scale.set(0.5, 0.5), a.anchor.set(0, 0.5), (a.x = (a.width - 1) * n), this._rails.addChild(a)
      }
      'v' == this._orienation
        ? ((this._rails.rotation = q.toRadians(90)), this.y > this._endY && (this._rails.y -= t))
    ...
    (S.prototype._stop = function () {
      ;(this._isMove = !1),
        ...
        lt.soundOn && (this.sndStart.stop(), this.sndStop.play())
    }),
    ...
    (I.prototype._shot = function (t) {
      this._cannon.playing ||
        ((this._shoted = !1), this._cannon.gotoAndStop(0), this._cannon.play(), lt.soundOn && this.sndShot.play())
    }),
    (I.prototype._pointerDown = function (t) {
      ;(this._isAllowMove = !0), (lt.playState.aim.visible = !0)
    }),
    (I.prototype._pointerUp = function (t) {
      ;(this._isAllowMove = !1), lt.playState.blinkBtnFire()
    }),
    (I.prototype._frameChanged = function (t) {
      if (t >= 8 && !this._shoted) {
        ...
        var e = 0,
          i = 0
        if (lt.playState.aimControl) (e = lt.playState.aim.position.x), (i = lt.playState.aim.position.y)
        else {
          var n = lt.pixi.renderer.plugins.interaction,
            a = n.pointer.global
          ;(e = a.x / lt.scale), (i = a.y / lt.scale)
        }
    ...
    (I.prototype._update = function (t) {
      if (this._isAllowMove) {
        var e = lt.pixi.renderer.plugins.interaction,
          i = e.pointer.global
        ;(i = { x: i.x / lt.scale, y: i.y / lt.scale }),
          lt.playState.aimControl && ((i.y -= 50), lt.playState.aim.position.set(i.x, i.y)),
    ...
    (E.prototype._onBeginContact = function (t) {
      var e = g.getAnotherOfContact(t, this)
      ;(e instanceof w || e instanceof D || e instanceof T) &&
        (this.btn.play(), i.events.emit(i.EVENT_TRIGGER_PRESSED, { id: this.id }))
    }),
    ...
    (A.prototype._onBeginContact = function (t) {
      if (!this._inUse) {
        var e = g.getAnotherOfContact(t, this)
        e instanceof w && i.events.emit(i.EVENT_TELEPORTATION, { sender: this, ball: e, id: this.id })
      }
    }),
    ...
    (G.prototype.constructor = G),
    (G.prototype._update = function () {
      i.prototype._update.call(this), this.y > lt.gameHeight0 + 100 && this.destroy()
    }),
    ...
    (F.prototype._onBtnsLevelClick = function (t) {
      ;(lt.levelMng.currLevel = t),
        lt.shutter.run(function () {
          this.destroy({ children: !0 }), (lt.menuState = null), new U()
        }, this),
        lt.soundOn && this.sndButton.play()
      try {
    ...
    (U.prototype.complete = function () {
      this._isComplete || ((this._isComplete = !0), this._levelComplete.show(0.5), lt.levelMng.onLevelComplete())
    }),
    (U.zOrder = {
      defaultZ: 100,
      cannon: 100,
    ...
    (U.prototype._onBtnsClick = function (t) {
      switch (t.target.name) {
        case 'Menu':
          lt.shutter.run(function () {
            this.destroy({ children: !0 }), (lt.playState = null), new F()
          }, this)
          break
        case 'Restart':
          lt.shutter.run(function () {
            try {
              parent.whgGameEvent('replay', lt.levelMng.currLevel)
            } catch (t) {}
            this.destroy({ children: !0 }), (lt.playState = null), new U()
          }, this)
          break
        case 'Next':
          lt.shutter.run(function () {
            ...
            try {
              parent.whgGameEvent('start', lt.levelMng.currLevel)
            } catch (t) {}
            this.destroy({ children: !0 }), (lt.playState = null), new U()
          }, this)
          break
    ...
    (X.prototype.create = function (t) {
      ;(t = t || this.currLevel),
        ...
        (this.currLevel = t),
        t--
      for (var e = ht[t].items, i = e.length, n = 0; n < i; n++) this._createItem(e[n])
    }),
    (X.prototype.onLevelComplete = function () {
      this.currLevel == this.lastOpened && (this.lastOpened++, lt.storage.set(lt.SAVE_KEY_LAST_OPENED, this.lastOpened))
    }),
  ...
  ;(ht[0] = {
    ...
    (ht[3] = {
      items: [
        ...
        { name: 'Gate', x: 600, y: 95, direction: 'left', gateLeftID: 1, openAngle: 45 },
        { name: 'Gate', x: 660, y: 95, direction: 'right', gateRightID: 1, openAngle: 45 },
        { name: 'Gate', x: 600, y: 130, direction: 'left', gateLeftID: 2, openAngle: 45 },
        { name: 'Gate', x: 660, y: 130, direction: 'right', gateRightID: 2, openAngle: 45 },
        { name: 'Gate', x: 600, y: 165, direction: 'left', gateLeftID: 3, openAngle: 45 },
        { name: 'Gate', x: 660, y: 165, direction: 'right', gateRightID: 3, openAngle: 45 },
        { name: 'Gate', x: 600, y: 200, direction: 'left', gateLeftID: 4, openAngle: 45 },
        { name: 'Gate', x: 660, y: 200, direction: 'right', gateRightID: 4, openAngle: 45 },
    ...
    (ht[4] = {
      items: [
        ...
        { name: 'Gate', x: 450, y: 320, direction: 'left', gateLeftID: 1, openAngle: 45 },
        { name: 'Gate', x: 510, y: 320, direction: 'right', gateRightID: 1, openAngle: 45 },
    ...
    (ht[5] = {
      items: [
        ...
        { name: 'Gate', x: 30, y: 330, direction: 'left', gateLeftID: 1, openAngle: 90 },
        { name: 'Gate', x: 90, y: 330, direction: 'right', gateRightID: 1, openAngle: 45 },
    ...
    (ht[6] = {
      items: [
        ...
        { name: 'Gate', x: 70, y: 200, direction: 'left', gateLeftID: 1, openAngle: 90 },
        { name: 'Gate', x: 130, y: 200, direction: 'right', gateRightID: 1, openAngle: 90 },
        { name: 'PushButton', x: 612.05, y: 333.5, angle: 0, btnID: 1 },
        { name: 'Platform', x: 583.85, y: 192.55, width: 281, angle: -90 },
        { name: 'Gate', x: 217.5, y: 417, direction: 'left', gateLeftID: 2, openAngle: 90, inversed: !0 },
        { name: 'Gate', x: 280, y: 417, direction: 'right', gateRightID: 2, openAngle: 90, inversed: !0 },
    ...
    (ht[7] = {
      items: [
        ...
        { name: 'Tube', x: 347, y: 76, angle: -90, plusSensorFront: 30, plusSensorBack: 30 },
        ...
        { name: 'Gate', x: 32.05, y: 113.05, direction: 'left', gateLeftID: 1, openAngle: 90 },
        { name: 'Gate', x: 92.05, y: 113.05, direction: 'right', gateRightID: 1, openAngle: 90 },
        ...
        { name: 'Gate', x: 316.05, y: 111.05, direction: 'left', gateLeftID: 2, openAngle: 90 },
        { name: 'Gate', x: 376.05, y: 111.05, direction: 'right', gateRightID: 2, openAngle: 90 },
    ...
    (ht[8] = {
      items: [
        ...
        { name: 'Cannon', x: 208.6, y: 442.85, lowerAngle: -45, upperAngle: 10 },
        { name: 'Basket', x: 50, y: 377 },
        { name: 'Platform', x: 430, y: 201.4, width: 99, angle: -90 },
        { name: 'Gate', x: 20, y: 330, direction: 'left', gateLeftID: 2, openAngle: 90 },
        { name: 'Gate', x: 80, y: 330, direction: 'right', gateRightID: 2, openAngle: 90 },
        { name: 'Platform', x: 99.95, y: 303.95, width: 302.1, angle: -90 },
        { name: 'Gate', x: 20, y: 170, direction: 'left', gateLeftID: 1, openAngle: 90 },
        { name: 'Gate', x: 80, y: 170, direction: 'right', gateRightID: 1, openAngle: 90 },
    ...
    (ht[9] = {
      items: [
        ...
        { name: 'Gate', x: 130, y: 80, direction: 'left', gateLeftID: 1, openAngle: 90 },
        { name: 'Gate', x: 190, y: 80, direction: 'right', gateRightID: 1, openAngle: 90 },
        ...
        { name: 'Gate', x: 570, y: 370, direction: 'left', gateLeftID: 2, openAngle: 90 },
        { name: 'Gate', x: 630, y: 370, direction: 'right', gateRightID: 2, openAngle: 90 },
    ...
    (ht[10] = {
      items: [
        ...
        { name: 'BasketRail', x: 380, y: 356, orientation: 1, end: 680, basketID: 1 },
    ...
    (ht[11] = {
      items: [
        ...
        { name: 'BasketRail', x: 35, y: 45, orientation: 0, end: 340, basketID: 1 },
    ...
    (ht[12] = {
      items: [
        ...
        { name: 'BasketRail', x: 650, y: 326, orientation: 1, end: 450, basketID: 1 },
        ...
        { name: 'Gate', x: 550, y: 66, direction: 'left', gateLeftID: 2, openAngle: 45 },
        { name: 'Gate', x: 610, y: 66, direction: 'right', gateRightID: 2, openAngle: 45 },
        { name: 'Ball', x: 580, y: 55 }
      ]
    }),
    (ht[13] = {
      items: [
        { name: 'Cannon', x: 355.6, y: 362.85, lowerAngle: -15, upperAngle: 15 },
        ...
        { name: 'BasketRail', x: 585, y: 133, orientation: 0, end: 433, basketID: 2 },
        ...
        { name: 'Gate', x: 50, y: 206, direction: 'left', gateLeftID: 1, openAngle: 90 },
        { name: 'Gate', x: 110, y: 206, direction: 'right', gateRightID: 1, openAngle: 90 },
    ...
    (ht[14] = {
      items: [
        { name: 'Cannon', x: 125.6, y: 352.85, lowerAngle: -45, upperAngle: 60 },
        { name: 'Platform', x: 674.1, y: 283.2, width: 90, angle: 0 },
        { name: 'Platform', x: 560.2, y: 365.45, width: 320, angle: 2 },
        { name: 'Gate', x: 330, y: 356, direction: 'left', gateLeftID: 1, openAngle: 45 },
        { name: 'Gate', x: 390, y: 356, direction: 'right', gateRightID: 1, openAngle: 45 },
        ...
        { name: 'BasketRail', x: 45, y: 421, orientation: 1, end: 645, basketID: 2 },
  ...
  ;(t.App = lt),
    ...
    (lt._checkAudio = function () {
      lt.audioEnabled
        ? (void 0 != lt.storage.get(lt.SAVE_KEY_MUSIC) && (lt.musicOn = 'true' == lt.storage.get(lt.SAVE_KEY_MUSIC)),
        ...
        : ((lt.musicOn = !1), (lt.soundOn = !1))
    }),
    (lt.setMusicEnable = function (t) {
      lt.audioEnabled !== !1 &&
        ((lt.musicOn = t),
        lt.musicOn
          ? lt.mainTheme.isPlaying || (lt.mainTheme.resume(), lt.mainTheme.isPlaying || lt.mainTheme.play())
          : lt.mainTheme.isPlaying && lt.mainTheme.pause(),
    ...
    (lt.setSoundEnable = function (t) {
      lt.audioEnabled !== !1 && ((lt.soundOn = t), lt.storage.set(lt.SAVE_KEY_SOUND, lt.soundOn))
    }),
    (lt.switchSoundEnable = function () {
      lt.setSoundEnable(!lt.soundOn)
    }),
    (t.unlockAllLevels = function () {
      lt.levelMng && lt.levelMng.unlockAllLevels(), lt.menuState && lt.menuState._levelsDialog.refresh()
    }),
